...
def iso_data_fetch_calc():
        ...
        noondata_fo_nor_sog = metadata.tables['NOONDATA_fo_nor_sog']
                        ...
                        if obj_noon[1] and obj_noon[4] and obj_noon[6]:
                                for iso_ves in iso_vesls:
                                        ...
                                        if iso_params:
                                                ...
                                                draft_pow = isoData_corr_power+((((1/iso_a_sc) * iso_noon_stw)**(1/iso_b_sc)) - (((1/iso_a_b) * iso_noon_stw)**(1/iso_b_b)))/(iso_disp_sc-iso_disp_b)*(iso_disp_16-iso_noon_displacement)
                                                fo_nor_dct={} 
                                                ...
                                                fo_nor_dct['draft_pow'] = draft_pow
                                                fo_nor_dct['STW']= obj_noon[17]
                                                fo_nor_dct['WindSpeed_kn'] = obj_noon[8]
                                                for val in val_lst:
                                                        draft_sp_pow = draft_pow*(val/iso_noon_stw)**iso_speedcoef
                                                        fo_nor_dct['draft_sp_pow'+str(val)]=draft_sp_pow
                                                        dct_isoparams_db['fo_nor_sog'] = (iso_f1*draft_sp_pow**2)+(iso_f2*draft_sp_pow)+iso_k
                                                        fo_nor_dct['fo_nor_sog'+str(val)] = dct_isoparams_db['fo_nor_sog']
                                                ins_lst.append(fo_nor_dct)
        try:
                insert_q = noondata_fo_nor_sog.insert()
                ...
                print(e)
                                                ...
                                                # 	dct_isoparams_db['P_I_SOG'] = isoData_perf_value
...
def alert_mail(str_error):
        ...
        body = ""
        body = "MTM  NOONDATA SOG ISO calculation not completed due to the error :-\n\n"+str(str_error)
